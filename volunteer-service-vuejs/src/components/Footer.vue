      ...
      <div class="row">
        <div class="col-md-6 col-6">
          <ul style="list-style-type: none">
            <li class="text-light font-weight-bold pb-2">Познайомитися з нами</li>
            <li><a class="footer-link font-weight-light" href="#">Про нас</a></li>
        ...
        <div class="col-md-6 col-6">
          <ul style="list-style-type: none">
            <li class="text-light font-weight-bold">Зв'яжіться з нами</li>
