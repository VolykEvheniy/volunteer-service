    ...
    <div id="background-div" class="page-holder bg-cover">
      ...
      <div class="container py-5">
        <header class="text-left text-white py-5">
          <h3 class="mb-4 rounded"><a href="#start-shopping" class="bg-white px-2 py-2 rounded" id="heading">Волонтерський сервіс для військових</a></h3>
          <p id="content" class="lead mb-0 bg-dark p-1 rounded">Це ваш надійний помічник на службі! Отримуйте гуманітарну допомогу легко і оперативно.
            Обирайте необхідні товари з широкого асортименту та насолоджуйтесь
            швидким і зручним процесом замовлення.</p>
        </header>
      </div>
    </div>
