...
import com.webtutsplus.ecommerce.dto.order.OrderItemsDto;
...
public class OrderService {
    ...
    public Order addOrder(User user, OrderMilitaryDto orderRequest) {
        // first let get cart items for the user
        CartDto cartDto = cartService.listCartItems(user);
        ...
        newOrder.setPostalService(orderRequest.getPostalService());
...
//    public void addOrder(User user, OrderMilitaryDto orderRequest) {
//        // create the order and save it
//        Order newOrder = new Order();
//        newOrder.setCreatedDate(new Date());
//        newOrder.setUser(user);
//        orderRepository.save(newOrder);
//
//        for (OrderItemsDto cartItemDto : orderRequest.getCartItems()) {
//            // create orderItem and save each one
//            OrderItem orderItem = new OrderItem();
//            orderItem.setCreatedDate(new Date());
//            orderItem.setProduct(cartItemDto.getProduct());
